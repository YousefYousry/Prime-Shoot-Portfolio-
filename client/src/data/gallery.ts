...
const galleryAssetSrc = (file: string) => `/assets/gallery/${file}`;
...
export const galleryCategories: GalleryCategory[] = [
  {
    ...
    coverImage: { src: "/assets/covers/prime-shot-behind-the-scenes-olive-noir.jpg", alt: "Prime Shot studio lighting setup behind the scenes" },
    images: [
      { src: "/assets/bts/bts-studio-camera-team.jpeg", alt: "Prime Shot team preparing a studio camera setup", frame: "portrait" },
      { src: "/assets/bts/bts-gimbal-team.jpeg", alt: "Prime Shot crew working with a gimbal during production", frame: "portrait-tall" },
      { src: "/assets/bts/bts-studio-directing.jpeg", alt: "Prime Shot studio production and creative direction", frame: "portrait" },
      { src: "/assets/bts/bts-outdoor-camera.png", alt: "Prime Shot outdoor camera setup", frame: "landscape" },
      { src: "/assets/bts/bts-outdoor-monitor.png", alt: "Prime Shot team reviewing an outdoor production monitor", frame: "landscape" },
      { src: "/assets/bts/bts-red-studio.jpeg", alt: "Prime Shot red studio lighting setup", frame: "portrait-tall" },
      ...
      { src: "/assets/bts/bts-smoke-lighting-landscape.jpeg", alt: "Prime Shot crew working through a smoke-lit behind-the-scenes set", frame: "landscape" },
    ],
  },
  {
    number: "02",
    ...
    coverImage: { src: "/assets/covers/prime-shot-model-shots-cover-olive-noir.png", alt: "Genoa model portrait in Prime Shot Olive Noir editorial styling" },
    images: [
  ...
  },
  {
    ...
    coverImage: { src: "/assets/covers/prime-shot-social-media-designs-general-cover.png", alt: "Prime Shot Olive Noir editorial still life representing social media design systems" },
    images: [
      ...[
      ...
      { src: "/assets/social/molton-floor-cleaner-campaign.png", alt: "Molton floor-cleaner social media campaign" },
      { src: "/assets/social/crown-wax-polish-campaign.png", alt: "Crown wax shoe-polish social media campaign" },
      { src: "/assets/social/crown-self-shining-sponges-campaign.png", alt: "Crown self-shining sponges social media campaign" },
    ],
  },
];
