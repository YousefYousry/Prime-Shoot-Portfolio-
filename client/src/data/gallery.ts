...
export const galleryCategories: GalleryCategory[] = [
  {
    ...
    images: [
      { src: "/manus-storage/bts-studio-camera-team_c0132889.jpeg", alt: "Prime Shot team preparing a studio camera setup" },
      { src: "/manus-storage/bts-gimbal-team_6aed68cb.jpeg", alt: "Prime Shot crew working with a gimbal during production" },
      { src: "/manus-storage/bts-studio-directing_5d7519e1.jpeg", alt: "Prime Shot studio production and creative direction" },
      { src: "/manus-storage/bts-outdoor-camera_5e2a2d2c.png", alt: "Prime Shot outdoor camera setup" },
      { src: "/manus-storage/bts-outdoor-monitor_3dc55a13.png", alt: "Prime Shot team reviewing an outdoor production monitor" },
      { src: "/manus-storage/bts-red-studio_3dd8a76a.jpeg", alt: "Prime Shot red studio lighting setup" },
      { src: "/manus-storage/bts-creative-shoot_79fb4543.webp", alt: "Prime Shot creative shoot preparation" },
      { src: "/manus-storage/bts-lighting-brief_03310185.webp", alt: "Prime Shot lighting and creative brief on set" },
    ],
  },
  {
    number: "02",
