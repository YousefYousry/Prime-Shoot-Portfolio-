    ...
    <main className="site-shell">
      <header className={`site-header ${menuOpen ? "menu-is-open" : ""}`}>
        <a className="brand-lockup" href="#top" onClick={closeMenu} aria-label="Prime Shot Creative home">
          <span className="brand-mark"><img src="/manus-storage/prime-shot-mark_9369cfa0.png" alt="" /></span>
          <span className="brand-name"><strong>PRIME SHOT</strong><em>CREATIVE</em></span>
        </a>
      ...
      <section id="top" className="hero-section">
        <div className="hero-image"><img src="/manus-storage/prime-shot-hero_ed9335a2.jpg" alt="Sculptural perfume bottle and folded fabric in a cinematic studio light" /></div>
      ...
      <section className="statement-section"><div className="statement-mark"><img src="/manus-storage/prime-shot-mark_9369cfa0.png" alt="" /></div><p>Good work begins with<br /><em>a point of view.</em></p><span className="statement-rule" /></section>

      <footer id="contact" className="site-footer section-pad"><div className="section-label"><span>04</span><span>Start a conversation</span></div><div className="footer-main"><h2>Have a project<br /><em>in mind?</em></h2><a className="footer-email" href="mailto:hello@primeshotcreative.com">hello@primeshotcreative.com <ArrowUpRight size={22} strokeWidth={1.2} /></a></div><div className="footer-identity"><span className="brand-mark"><img src="/manus-storage/prime-shot-mark_9369cfa0.png" alt="" /></span><span className="brand-name"><strong>PRIME SHOT</strong><em>CREATIVE</em></span></div><div className="footer-bottom"><span>© 2026 Prime Shot Creative</span><span>Alexandria / Cairo</span><a href="#top">Back to top ↑</a></div></footer>
    </main>
  );
}
